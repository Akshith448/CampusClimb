...
def evaluate():
    ...
    input_path = os.path.join(os.path.dirname(__file__), "..", "results", "mapping_pairs.csv")
    ...
    output_path = os.path.join(os.path.dirname(__file__), "..", "results", "mapping_results.txt")
